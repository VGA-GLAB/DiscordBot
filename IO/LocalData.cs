...
class LocalData
{
    ...
    /// <returns></returns>
    static public T Load<T>(string file, string path = ".", bool fenc = false)
    {
        try
        {
            //ファイルがなかったらnullで返す
    ...
    static public async Task<T> LoadAsync<T>(string file, string path = ".", bool fenc = false)
    {
        try
        {
            //ファイルがなかったらnullで返す
    ...
    /// <param name="fenc">暗号化を強制的に書けたいときに指定</param>
    /// <returns></returns>
    static public void Save<T>(string file, T data, string path = ".", bool fenc = false)
    {
        try
        {
    ...
    static public async Task SaveAsync<T>(string file, T data, string path = ".", bool fenc = false)
    {
        try
        {
            var json = JsonConvert.SerializeObject(data);
    ...
    /// <param name="path">保存先を変えたいときに指定</param>
    /// <returns></returns>
    static public void Delete(string file, string path = ".")
    {
        //ファイルがなかったらnullで返す
        if (!File.Exists(path + "/" + file))
        {
